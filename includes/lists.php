...
if ( ! function_exists('sweat_get_not_selected_text') ) {
	/**
	 ...
	 */
	function sweat_get_not_selected_text( $label ) {
		return apply_filters( 'sweat_filter_not_selected_text',
								sprintf( apply_filters( 'sweat_filter_not_selected_mask', __( '- %s -', 'sweat' ) ), $label )
							);
	}
}

if ( ! function_exists( 'sweat_get_list_range' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_range( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			$list[ $i ] = $i;
		}
...
if ( ! function_exists( 'sweat_get_list_styles' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_styles( $from = 1, $to = 2, $prepend_inherit = false ) {
		$list = array();
		for ( $i = $from; $i <= $to; $i++ ) {
			// Translators: Add number to the style name 'Style 1', 'Style 2' ...
			$list[ $i ] = sprintf( esc_html__( 'Style %d', 'sweat' ), $i );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_yesno' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_yesno( $prepend_inherit = false ) {
		$list = array(
			'yes' => esc_html__( 'Yes', 'sweat' ),
			'no'  => esc_html__( 'No', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_checkbox_values' ) ) {
	/**
	 ...
	 * @return array                 An associative array with 'yes' and 'no' elements.
	 */
	function sweat_get_list_checkbox_values( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_checkbox_values', array(
				1         => esc_html__( 'Yes', 'sweat' ),
				0         => esc_html__( 'No', 'sweat' ),
			)
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'sweat_get_list_onoff' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_onoff( $prepend_inherit = false ) {
		$list = array(
			'on'  => esc_html__( 'On', 'sweat' ),
			'off' => esc_html__( 'Off', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_showhide' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_showhide( $prepend_inherit = false ) {
		$list = array(
			'show' => esc_html__( 'Show', 'sweat' ),
			'hide' => esc_html__( 'Hide', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_visiblehidden' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_visiblehidden( $prepend_inherit = false ) {
		$list = array(
			'visible' => esc_html__( 'Visible', 'sweat' ),
			'hidden'  => esc_html__( 'Hidden', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_directions' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_directions( $prepend_inherit = false ) {
		$list = array(
			'horizontal' => esc_html__( 'Horizontal', 'sweat' ),
			'vertical'   => esc_html__( 'Vertical', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_paddings' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_paddings( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_paddings', array(
				'none'  => array(
							'title' => esc_html__( 'No Padding', 'sweat' ),
							'icon'  => 'images/theme-options/section-padding/none.png',
						),
				'small'  => array(
							'title' => esc_html__( 'Small Padding', 'sweat' ),
							'icon'  => 'images/theme-options/section-padding/small.png',
						),
				'medium' => array(
							'title' => esc_html__( 'Medium Padding', 'sweat' ),
							'icon'  => 'images/theme-options/section-padding/medium.png',
						),
				'large' => array(
							'title' => esc_html__( 'Large Padding', 'sweat' ),
...
if ( ! function_exists( 'sweat_get_list_hovers' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_hovers( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_hovers', array(
				'dots'    => esc_html__( 'Dots', 'sweat' ),
				'icon'    => esc_html__( 'Icon', 'sweat' ),
				'icons'   => esc_html__( 'Icons', 'sweat' ),
				'zoom'    => esc_html__( 'Zoom', 'sweat' ),
				'fade'    => esc_html__( 'Fade', 'sweat' ),
				'slide'   => esc_html__( 'Slide', 'sweat' ),
				'pull'    => esc_html__( 'Pull', 'sweat' ),
				'border'  => esc_html__( 'Border', 'sweat' ),
				'excerpt' => esc_html__( 'Excerpt', 'sweat' ),
				'info'    => esc_html__( 'Info', 'sweat' ),
			)
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'sweat_get_list_blog_contents' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_blog_contents( $prepend_inherit = false ) {
		$list = array(
				'excerpt'  => esc_html__( 'Excerpt', 'sweat' ),
				'fullpost' => esc_html__( 'Full post', 'sweat' ),
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_blog_paginations' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_blog_paginations( $prepend_inherit = false ) {
		$list = array(
					'pages'    => array(
					...
					'links'    => array(
										'title' => esc_html__( 'Older/Newest', 'sweat' ),
...
if ( ! function_exists( 'sweat_get_list_sidebars' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_sidebars( $prepend_inherit = false, $add_hide = false ) {
		$list = sweat_storage_get( 'list_sidebars' );
		if ( '' == $list ) {
			...
			sweat_storage_set( 'list_sidebars', $list );
		}
		if ( $add_hide ) {
			$list = sweat_array_merge( array( 'hide' => sweat_get_not_selected_text( esc_html__( 'Select widgets', 'sweat' ) ) ), $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_sidebars_positions' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_sidebars_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_sidebars_positions', array(
				'hide'  => array(
							'title' => esc_html__( 'No sidebar', 'sweat' ),
							'icon'  => 'images/theme-options/sidebar-position/hide.png',
						),
				'left'  => array(
							'title' => esc_html__( 'Left sidebar', 'sweat' ),
							'icon'  => 'images/theme-options/sidebar-position/left.png',
						),
				'right' => array(
							'title' => esc_html__( 'Right sidebar', 'sweat' ),
...
if ( ! function_exists( 'sweat_get_list_sidebars_positions_ss' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_sidebars_positions_ss( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_sidebars_positions_ss', array(
				'above' => esc_html__( 'Above the content', 'sweat' ),
				'below' => esc_html__( 'Below the content', 'sweat' ),
				'float' => esc_html__( 'Floating bar', 'sweat' ),
			)
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
...
if ( ! function_exists( 'sweat_get_list_sidebar_styles' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_sidebar_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'sweat_filter_list_sidebar_styles', array() );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_header_footer_types' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_header_footer_types( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_header_footer_types', array(
...
if ( ! function_exists( 'sweat_get_list_header_styles' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_header_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'sweat_filter_list_header_styles', array() );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_header_positions' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_header_positions( $prepend_inherit = false ) {
		$list = apply_filters( 'sweat_filter_list_header_positions', array(
			'default' => esc_html__( 'Default', 'sweat' ),
			'over'    => esc_html__( 'Over', 'sweat' ),
			'under'   => esc_html__( 'Under', 'sweat' ),
		) );
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_footer_styles' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_footer_styles( $prepend_inherit = false ) {
		static $list = false;
		if ( ! $list ) {
			$list = apply_filters( 'sweat_filter_list_footer_styles', array() );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_body_styles' ) ) {
	/**
	 ...
	 *                                This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_body_styles( $prepend_inherit = false, $force_fullscreen = false ) {
		$list = array(
			'boxed' => array(
						'title' => esc_html__( 'Boxed', 'sweat' ),
						'icon'  => 'images/theme-options/body-style/boxed.png',
					),
			'wide'  => array(
						'title' => esc_html__( 'Wide', 'sweat' ),
						'icon'  => 'images/theme-options/body-style/wide.png',
					),
		);
		if ( apply_filters( 'sweat_filter_allow_fullscreen', $force_fullscreen || sweat_get_theme_setting( 'allow_fullscreen' ) || sweat_get_edited_post_type() == 'page' ) ) {
			if ( sweat_get_theme_setting( 'allow_fullwide', true ) ) {
				$list['fullwide']   = array(
										'title' => esc_html__( 'Fullwidth', 'sweat' ),
										'icon'  => 'images/theme-options/body-style/fullwide.png',
										);
			}
			$list['fullscreen'] = array(
									'title' => esc_html__( 'Fullscreen', 'sweat' ),
									'icon'  => 'images/theme-options/body-style/fullscreen.png',
									);
		}
		$list = apply_filters( 'sweat_filter_list_body_styles', $list );
		return $prepend_inherit
					? sweat_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'sweat_get_list_expand_content' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_expand_content( $prepend_inherit = false, $narrow = false ) {
		$list = apply_filters(
			'sweat_filter_list_expand_content', array_merge(
				( $narrow
					? array(
						'narrow' => array(
								'title' => esc_html__( 'Narrow', 'sweat' ),
...
if ( ! function_exists( 'sweat_get_list_remove_margins' ) ) {
	/**
	 ...
	 *                               This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_remove_margins( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_remove_margins', array(
				'0'  => array(
							'title' => esc_html__( 'Margins On', 'sweat' ),
							'icon'  => 'images/theme-options/remove-margins/on.png',
						),
				'1'  => array(
							'title' => esc_html__( 'Margins Off', 'sweat' ),
...
if ( ! function_exists( 'sweat_get_list_meta_parts' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_meta_parts( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_meta_parts',
			array(
				'author'     => esc_html__( 'Post author', 'sweat' ),
				'date'       => esc_html__( 'Published date', 'sweat' ),
				'modified'   => esc_html__( 'Modified date', 'sweat' ),
				'views'      => esc_html__( 'Views', 'sweat' ),
				'likes'      => esc_html__( 'Likes', 'sweat' ),
				'comments'   => esc_html__( 'Comments', 'sweat' ),
				'share'      => esc_html__( 'Share links', 'sweat' ),
				'categories' => esc_html__( 'Categories', 'sweat' ),
				'edit'       => esc_html__( 'Edit link', 'sweat' ),
			)
		);
...
if ( ! function_exists( 'sweat_get_list_share_links_positions' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_share_links_positions( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_list_share_links_positions',
			array(
...
if ( ! function_exists( 'sweat_get_list_blog_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_blog_styles( $prepend_inherit = false, $filter = 'arh', $need_custom = true ) {
		$list   = array();
					...
					if ( 'arh' == $filter && isset( $v['columns'] ) && is_array( $v['columns'] ) ) {
						...
						foreach ( $v['columns'] as $col ) {
							...
							$list[ "{$k}_{$col}" ] = 'arh' == $filter
														? array(
															'title'   => sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'sweat' ), $v['title'], $col ),
															'icon'    => ! empty( $v['icon'] )
																			? ( strpos( $v['icon'], '%d' ) !== false ? sprintf( $v['icon'], $col ) : $v['icon'] )
																			: 'images/theme-options/blog-style/custom.png',
															'new_row' => $new_row,
															)
														: sprintf( _n( '%1$s %2$d Column', '%1$s %2$d Columns', $col, 'sweat' ), $v['title'], $col );
							$new_row = false;
						}
					} else {
						$list[ $k ] = 'arh' == $filter
		...
		$list = apply_filters( 'sweat_filter_list_blog_styles', $list, $filter, $need_custom );
		return $prepend_inherit
					? sweat_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'sweat_get_list_single_styles' ) ) {
	/**
	 ...
	 *                                 This format used to show elements in the 'icons' style instead dropdown.
	 */
	function sweat_get_list_single_styles( $prepend_inherit = false ) {
		$list = apply_filters( 'sweat_filter_list_single_styles', sweat_storage_get( 'single_styles' ) );
		return $prepend_inherit
					? sweat_array_merge(
							array( 
								'inherit' => array(
...
if ( ! function_exists( 'sweat_get_list_categories' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_categories( $prepend_inherit = false ) {
		$list = sweat_storage_get( 'list_categories' );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					$list[ $cat->term_id ] = apply_filters( 'sweat_filter_term_name', $cat->name, $cat );
				}
			}
			sweat_storage_set( 'list_categories', $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_terms' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_terms( $prepend_inherit = false, $taxonomy = 'category' ) {
		$list = sweat_storage_get( 'list_taxonomies_' . ( $taxonomy ) );
		if ( '' == $list ) {
			$list       = array();
			...
			if ( is_array( $taxonomies ) && count( $taxonomies ) > 0 ) {
				foreach ( $taxonomies as $cat ) {
					...
					$list[ $cat->term_id ] = apply_filters( 'sweat_filter_term_name', $cat->name . ( false && 'category' != $taxonomy ? " /{$cat->taxonomy}/" : '' ), $cat );
				}
			}
			sweat_storage_set( 'list_taxonomies_' . ( $taxonomy ), $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_posts_types' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_posts_types( $prepend_inherit = false ) {
		$list = sweat_storage_get( 'list_posts_types' );
		if ( '' == $list ) {
			$list = apply_filters(
				'sweat_filter_list_posts_types', array(
					'post' => esc_html__( 'Post', 'sweat' ),
				)
			);
			sweat_storage_set( 'list_posts_types', $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_posts' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_posts( $prepend_inherit = false, $opt = array() ) {
		$opt = array_merge(
			array(
				'post_type'        => 'post',
				'post_status'      => 'publish',
		...
		$list = sweat_storage_get( $hash );
		if ( '' == $list ) {
			$list = array();
			if ( false !== $opt['not_selected'] ) {
				$list['none'] = true === $opt['not_selected'] ? sweat_get_not_selected_text( esc_html__( 'Not selected', 'sweat' ) ) : $opt['not_selected'];
			}
			$args = array(
			...
			sweat_storage_set( $hash, $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_pages' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_pages( $prepend_inherit = false, $opt = array() ) {
		...
		return sweat_get_list_posts( $prepend_inherit, $opt );
	}
}

if ( ! function_exists( 'sweat_get_list_users' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_users( $prepend_inherit = false, $roles = array( 'administrator', 'editor', 'author', 'contributor', 'shop_manager' ) ) {
		$list = sweat_storage_get( 'list_users' );
		if ( '' == $list ) {
			$list         = array();
			$list['none'] = sweat_get_not_selected_text( esc_html__( 'Not selected', 'sweat' ) );
			$users        = get_users(
				array(
			...
			sweat_storage_set( 'list_users', $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_menus' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_menus( $prepend_inherit = false ) {
		$list = sweat_storage_get( 'list_menus' );
		if ( '' == $list ) {
			$list            = array();
			$list['default'] = esc_html__( 'Default', 'sweat' );
			...
			sweat_storage_set( 'list_menus', $list );
		}
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_icons' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_icons( $style = 'icons', $prepend_inherit = false ) {
		$lists = sweat_is_off( sweat_get_theme_option( 'debug_mode' ) ) ? get_transient( 'sweat_list_icons' ) : false;
		if ( ! is_array( $lists ) || ! isset( $lists[ $style ] ) || ! is_array( $lists[ $style ] ) || count( $lists[ $style ] ) < 2 ) {
			$lists = array();
			if ( 'icons' == $style ) {
				$lists[ $style ] = sweat_array_from_list( sweat_get_list_icons_classes( $prepend_inherit ) );
			} elseif ( 'images' == $style ) {
				$lists[ $style ] = sweat_get_list_images();
			} else { // 'svg'
				$lists[ $style ] = sweat_get_list_images( false, 'svg' );
			}
			if ( sweat_is_off( sweat_get_theme_option( 'debug_mode' ) ) && is_admin() && is_array( $lists[ $style ] ) && count( $lists[ $style ] ) > 1 ) {
				set_transient( 'sweat_list_icons', $lists, 6 * 60 * 60 );       // Store to the cache for 6 hours
			}
		}
		return $lists[ $style ];
	}
...
if ( ! function_exists( 'sweat_get_list_icons_classes' ) ) {
	/**
	 ...
	 * @return array                  An associative array with icons.
	 */
	function sweat_get_list_icons_classes( $prepend_inherit = false ) {
		static $list = false;
		if ( ! is_array( $list ) ) {
			$list = ! is_admin() ? array() : sweat_parse_icons_classes( sweat_get_file_dir( 'css/font-icons/css/fontello-codes.css' ) );
		}
		$list = ! is_array( $list ) ? array() : sweat_array_merge( array( 'none' => 'none' ), $list );
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
}

if ( ! function_exists( 'sweat_get_list_images' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_images( $prepend_inherit = false, $type = 'png' ) {
...
if ( ! function_exists( 'sweat_get_list_sc_color_styles' ) ) {
	/**
	 ...
	 */
	function sweat_get_list_sc_color_styles( $prepend_inherit = false ) {
		$list = apply_filters(
			'sweat_filter_get_list_sc_color_styles', array(
				'default' => esc_html__( 'Default', 'sweat' ),
				'link2'   => esc_html__( 'Accent 2', 'sweat' ),
				'link3'   => esc_html__( 'Accent 3', 'sweat' ),
				'dark'    => esc_html__( 'Dark', 'sweat' ),
			)
		);
		return $prepend_inherit ? sweat_array_merge( array( 'inherit' => esc_html__( 'Inherit', 'sweat' ) ), $list ) : $list;
	}
