...
if ( ! function_exists( 'sweat_storage_get' ) ) {
	/**
	 ...
	 */
	function sweat_storage_get( $var_name, $default = '' ) {
		global $SWEAT_STORAGE;
		return isset( $SWEAT_STORAGE[ $var_name ] ) ? $SWEAT_STORAGE[ $var_name ] : $default;
	}
}

if ( ! function_exists( 'sweat_storage_set' ) ) {
	/**
	 ...
	 */
	function sweat_storage_set( $var_name, $value ) {
		global $SWEAT_STORAGE;
		$SWEAT_STORAGE[ $var_name ] = $value;
	}
}

if ( ! function_exists( 'sweat_storage_empty' ) ) {
	/**
	 ...
	 */
	function sweat_storage_empty( $var_name, $key = '', $key2 = '' ) {
		global $SWEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return empty( $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return empty( $SWEAT_STORAGE[ $var_name ][ $key ] );
		} else {
			return empty( $SWEAT_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'sweat_storage_isset' ) ) {
	/**
	 ...
	 */
	function sweat_storage_isset( $var_name, $key = '', $key2 = '' ) {
		global $SWEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			return isset( $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
		} elseif ( '' !== $key ) {
			return isset( $SWEAT_STORAGE[ $var_name ][ $key ] );
		} else {
			return isset( $SWEAT_STORAGE[ $var_name ] );
		}
	}
}

if ( ! function_exists( 'sweat_storage_unset' ) ) {
	/**
	 ...
	 */
	function sweat_storage_unset( $var_name, $key = '', $key2 = '' ) {
		global $SWEAT_STORAGE;
		if ( '' !== $key && '' !== $key2 ) {
			if ( isset( $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] ) ) {
				unset( $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] );
			}
		} elseif ( '' !== $key ) {
			if ( isset( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
				unset( $SWEAT_STORAGE[ $var_name ][ $key ] );
			}
		} else {
			if ( isset( $SWEAT_STORAGE[ $var_name ] ) ) {
				unset( $SWEAT_STORAGE[ $var_name ] );
			}
		}
	}
}

if ( ! function_exists( 'sweat_storage_inc' ) ) {
	/**
	 ...
	 */
	function sweat_storage_inc( $var_name, $value = 1 ) {
		global $SWEAT_STORAGE;
		if ( empty( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = 0;
		}
		$SWEAT_STORAGE[ $var_name ] += $value;
	}
}

if ( ! function_exists( 'sweat_storage_concat' ) ) {
	/**
	 ...
	 */
	function sweat_storage_concat( $var_name, $value ) {
		global $SWEAT_STORAGE;
		if ( empty( $SWEAT_STORAGE[ $var_name ] ) ) {
...
if ( ! function_exists( 'sweat_storage_get_array' ) ) {
	/**
	 ...
	 */
	function sweat_storage_get_array( $var_name, $key, $key2 = '', $default = '' ) {
		global $SWEAT_STORAGE;
		if ( '' === $key2 ) {
			return ! empty( $var_name ) && '' !== $key && isset( $SWEAT_STORAGE[ $var_name ][ $key ] ) ? $SWEAT_STORAGE[ $var_name ][ $key ] : $default;
		} else {
			return ! empty( $var_name ) && '' !== $key && isset( $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] ) ? $SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] : $default;
		}
	}
}

if ( ! function_exists( 'sweat_storage_set_array' ) ) {
	/**
	 ...
	 */
	function sweat_storage_set_array( $var_name, $key, $value ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $SWEAT_STORAGE[ $var_name ] ) ) {
			if ( '' === $key ) {
				$SWEAT_STORAGE[ $var_name ][] = $value;
			} else {
...
if ( ! function_exists( 'sweat_storage_set_array2' ) ) {
	/**
	 ...
	 * @param mixed  $value     A new value for the specified element of the array.
	 */
	function sweat_storage_set_array2( $var_name, $key, $key2, $value ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( ! isset( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$SWEAT_STORAGE[ $var_name ][ $key ] = array();
		}
		if ( is_array( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
			if ( '' === $key2 ) {
				$SWEAT_STORAGE[ $var_name ][ $key ][] = $value;
			} else {
				$SWEAT_STORAGE[ $var_name ][ $key ][ $key2 ] = $value;
			}
		}
	}
}

if ( ! function_exists( 'sweat_storage_merge_array' ) ) {
	/**
	 ...
	 */
	function sweat_storage_merge_array( $var_name, $key, $value ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			$SWEAT_STORAGE[ $var_name ] = array_merge( $SWEAT_STORAGE[ $var_name ], $value );
		} else {
			$SWEAT_STORAGE[ $var_name ][ $key ] = array_merge( $SWEAT_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'sweat_storage_set_array_after' ) ) {
	/**
	 ...
	 */
	function sweat_storage_set_array_after( $var_name, $after, $key, $value = '' ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			sweat_array_insert_after( $SWEAT_STORAGE[ $var_name ], $after, $key );
		} else {
			sweat_array_insert_after( $SWEAT_STORAGE[ $var_name ], $after, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'sweat_storage_set_array_before' ) ) {
	/**
	 * Insert new elements to the array in the global theme storage
	 ...
	 * @param mixed        $value     A new value to insert (if the argument $key is a string).
	 */
	function sweat_storage_set_array_before( $var_name, $before, $key, $value = '' ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( is_array( $key ) ) {
			sweat_array_insert_before( $SWEAT_STORAGE[ $var_name ], $before, $key );
		} else {
			sweat_array_insert_before( $SWEAT_STORAGE[ $var_name ], $before, array( $key => $value ) );
		}
	}
}

if ( ! function_exists( 'sweat_storage_push_array' ) ) {
	/**
	 ...
	 */
	function sweat_storage_push_array( $var_name, $key, $value ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( '' === $key ) {
			array_push( $SWEAT_STORAGE[ $var_name ], $value );
		} else {
			if ( ! isset( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
				$SWEAT_STORAGE[ $var_name ][ $key ] = array();
			}
			array_push( $SWEAT_STORAGE[ $var_name ][ $key ], $value );
		}
	}
}

if ( ! function_exists( 'sweat_storage_pop_array' ) ) {
	/**
	 ...
	 */
	function sweat_storage_pop_array( $var_name, $key = '', $defa = '' ) {
		global $SWEAT_STORAGE;
		$rez = $defa;
		if ( '' === $key ) {
			if ( isset( $SWEAT_STORAGE[ $var_name ] ) && is_array( $SWEAT_STORAGE[ $var_name ] ) && count( $SWEAT_STORAGE[ $var_name ] ) > 0 ) {
				$rez = array_pop( $SWEAT_STORAGE[ $var_name ] );
			}
		} else {
			if ( isset( $SWEAT_STORAGE[ $var_name ][ $key ] ) && is_array( $SWEAT_STORAGE[ $var_name ][ $key ] ) && count( $SWEAT_STORAGE[ $var_name ][ $key ] ) > 0 ) {
				$rez = array_pop( $SWEAT_STORAGE[ $var_name ][ $key ] );
			}
		}
		return $rez;
	}
...
if ( ! function_exists( 'sweat_storage_inc_array' ) ) {
	/**
	 ...
	 * @param int          $value     Optional. A value for increment. Default is 1. Specify -1 to decrement or any legal number value.
	 */
	function sweat_storage_inc_array( $var_name, $key, $value = 1 ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( empty( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$SWEAT_STORAGE[ $var_name ][ $key ] = 0;
		}
		$SWEAT_STORAGE[ $var_name ][ $key ] += $value;
	}
}

if ( ! function_exists( 'sweat_storage_concat_array' ) ) {
	/**
	 ...
	 * @param int          $value     A value to concatenate.
	 */
	function sweat_storage_concat_array( $var_name, $key, $value ) {
		global $SWEAT_STORAGE;
		if ( ! isset( $SWEAT_STORAGE[ $var_name ] ) ) {
			$SWEAT_STORAGE[ $var_name ] = array();
		}
		if ( empty( $SWEAT_STORAGE[ $var_name ][ $key ] ) ) {
			$SWEAT_STORAGE[ $var_name ][ $key ] = '';
		}
		$SWEAT_STORAGE[ $var_name ][ $key ] .= $value;
	}
}

if ( ! function_exists( 'sweat_storage_call_obj_method' ) ) {
	/**
	 ...
	 */
	function sweat_storage_call_obj_method( $var_name, $method, $param = null ) {
		global $SWEAT_STORAGE;
		if ( null === $param ) {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $SWEAT_STORAGE[ $var_name ] ) ? $SWEAT_STORAGE[ $var_name ]->$method() : '';
		} else {
			return ! empty( $var_name ) && ! empty( $method ) && isset( $SWEAT_STORAGE[ $var_name ] ) ? $SWEAT_STORAGE[ $var_name ]->$method( $param ) : '';
		}
	}
}

if ( ! function_exists( 'sweat_storage_get_obj_property' ) ) {
	/**
	 ...
	 */
	function sweat_storage_get_obj_property( $var_name, $prop, $default = '' ) {
		global $SWEAT_STORAGE;
		return ! empty( $var_name ) && ! empty( $prop ) && isset( $SWEAT_STORAGE[ $var_name ]->$prop ) ? $SWEAT_STORAGE[ $var_name ]->$prop : $default;
	}
}
