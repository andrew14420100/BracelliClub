...
?><header class="top_panel top_panel_default
	<?php
	echo ! empty( $sweat_header_image ) || ! empty( $sweat_header_video ) ? ' with_bg_image' : ' without_bg_image';
...
">
	...
	// Main menu
	get_template_part( apply_filters( 'sweat_filter_get_template_part', 'templates/header-navi' ) );

	// Mobile header
	if ( sweat_is_on( sweat_get_theme_option( 'header_mobile_enabled' ) ) ) {
		get_template_part( apply_filters( 'sweat_filter_get_template_part', 'templates/header-mobile' ) );
	}

	// Page title and breadcrumbs area
	if ( ! is_single() ) {
		get_template_part( apply_filters( 'sweat_filter_get_template_part', 'templates/header-title' ) );
	}
