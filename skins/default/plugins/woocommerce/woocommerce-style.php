...
if ( ! function_exists( 'sweat_woocommerce_get_css' ) ) {
	add_filter( 'sweat_filter_get_css', 'sweat_woocommerce_get_css', 10, 2 );
	function sweat_woocommerce_get_css( $css, $args ) {
...
$fdir = sweat_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
