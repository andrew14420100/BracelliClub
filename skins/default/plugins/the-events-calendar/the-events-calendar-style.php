...
if ( ! function_exists( 'sweat_tribe_events_get_css' ) ) {
	add_filter( 'sweat_filter_get_css', 'sweat_tribe_events_get_css', 10, 2 );
	function sweat_tribe_events_get_css( $css, $args ) {
