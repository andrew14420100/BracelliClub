...
Please install and activate it before starting to use the theme Sweat.
...
Theme documentation is available on https://doc.themerex.net/sweat/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Sweat is Fontello.
